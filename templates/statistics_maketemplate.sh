...
sed -i 's\_SUFFIX\_dbl\g'  ../src/statistics_dbl.h
sed -i 's\_SUFFIX\_flt\g'  ../src/statistics_flt.h
...
sed -i 's\_SUFFIX\_dbl\g'  ../src/statistics_dbl.c
sed -i 's\_SUFFIX\_flt\g'  ../src/statistics_flt.c
