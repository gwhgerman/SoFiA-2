...
///                                                                      ///
/// SoFiA 2.0.1 (sofia.c) - Source Finding Application                   ///
...
int main(int argc, char **argv)
{
	...
	else
	{
		...
		if(cadence % DataCube_get_axis_size(dataCube, 0) == 0) cadence -= 1;  // Ensure stride is not equal to multiple of x-axis size
